/*
 * THEME ENFORCEMENT - FORCE DARK MODE ALWAYS
 */
// ULTRA AGGRESSIVE DARK THEME ENFORCEMENT
...
// Force body styles immediately and continuously
const forceBodyDarkTheme = () => {
  if (document.body) {
...
// Watch for body creation and any changes
const observer = new MutationObserver(() => {
  forceBodyDarkTheme();
  // Keep applying the class to html as well
  document.documentElement.classList.add("force-dark-theme");
});
...
window.addEventListener("load", forceBodyDarkTheme);
window.addEventListener("DOMContentLoaded", forceBodyDarkTheme);
